...
import drewhamilton.inlinedimens.iterators.SpIntIterator

/**
 * An array of [SpInt]. When compiled, instances of this class are inlined to int[] on the JVM.
 */
inline class SpIntArray(internal val ints: IntArray) {
     ...
     */
    operator fun get(index: Int): SpInt = SpInt(ints[index])
    ...
    operator fun iterator(): SpIntIterator = SpIntIterator(ints.iterator())
}
